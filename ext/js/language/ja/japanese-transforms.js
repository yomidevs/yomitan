    ...
    transforms: {
        ...
        '-んとする': {
            ...
            rules: [
                ...
                suffixInflection('はんとする', 'う', ['vs'], ['v5']),
        ...
        'negative': {
            ...
            rules: [
                ...
                suffixInflection('はない', 'う', ['adj-i'], ['v5']),
        ...
        '-ふ': {
            name: '-ふ',
            description: 'Historical kana orthography (歴史的仮名遣い) for the dictionary/terminal form of ワ行五段 verbs, used in pre-1946 and literary/classical Japanese (e.g. 思ふ for 思う).',
            i18n: [
                {
                    language: 'ja',
                    name: '～ふ（歴史的仮名遣い）',
                    description: '「～う」の歴史的仮名遣い表記',
                },
            ],
            rules: [
