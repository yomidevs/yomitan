    ...
    transforms: {
        '-ba': {
            ...
            rules: [
                ...
                suffixInflection('ますれば', 'ます', ['-ba'], ['-masu']),
            ],
        },
        '-ya': {
            name: '-ya',
        ...
        '-n past': {
            ...
            rules: [
                suffixInflection('んかった', 'る', ['past'], ['v1']),
                suffixInflection('かんかった', 'く', ['past'], ['v5']),
                suffixInflection('がんかった', 'ぐ', ['past'], ['v5']),
                suffixInflection('さんかった', 'す', ['past'], ['v5']),
                suffixInflection('たんかった', 'つ', ['past'], ['v5']),
                suffixInflection('なんかった', 'ぬ', ['past'], ['v5']),
                suffixInflection('ばんかった', 'ぶ', ['past'], ['v5']),
                suffixInflection('まんかった', 'む', ['past'], ['v5']),
                suffixInflection('らんかった', 'る', ['past'], ['v5']),
                suffixInflection('わんかった', 'う', ['past'], ['v5']),
                suffixInflection('ぜんかった', 'ずる', ['past'], ['vz']),
                suffixInflection('せんかった', 'する', ['past'], ['vs']),
                suffixInflection('為んかった', '為る', ['past'], ['vs']),
                suffixInflection('こんかった', 'くる', ['past'], ['vk']),
                suffixInflection('来んかった', '来る', ['past'], ['vk']),
                suffixInflection('來んかった', '來る', ['past'], ['vk']),
                suffixInflection('かった', '', ['past'], ['-masen']),
            ],
        },
        '-nbakari': {
            name: '-nbakari',
