...
const tests = [
    ...
    },
    {
        ...
        tests: [
            ...
            {term: '아릅답다', source: '아름답습니다',    rule: 'adj', reasons: ['-(스)ㅂ니다']},
            {term: '아릅답다', source: '아름다워요',      rule: 'adj', reasons: ['-아/어요']},
            {term: '아릅답다', source: '아름다워',        rule: 'adj', reasons: ['-아/어']},
            {term: '다릅답다', source: '아름다웠습니다',  rule: 'adj', reasons: ['-았/었', '-(스)ㅂ니다']},
            {term: '아릅답다', source: '아름다웠어요',    rule: 'adj', reasons: ['-았/었', '-아/어요']},
            {term: '아릅답다', source: '아름다웠어',      rule: 'adj', reasons: ['-았/었', '-아/어']},
            {term: '아릅답다', source: '아름다웠다',      rule: 'adj', reasons: ['-았/었', '-다']},
            {term: '아릅답다', source: '아름답겠습니다',  rule: 'adj', reasons: ['-겠', '-(스)ㅂ니다']},
            {term: '아릅답다', source: '아름답겠어요',    rule: 'adj', reasons: ['-겠', '-아/어요']},
            {term: '아릅답다', source: '아름답겠어',      rule: 'adj', reasons: ['-겠', '-아/어']},
            {term: '아릅답다', source: '아름답겠다',      rule: 'adj', reasons: ['-겠', '-다']},
            {term: '아릅답다', source: '아름답습니까',    rule: 'adj', reasons: ['-(스)ㅂ니까']},
            {term: '아릅답다', source: '아름답냐',        rule: 'adj', reasons: ['-(으)냐']},
            {term: '아릅답다', source: '아름다웠습니까',   rule: 'adj', reasons: ['-았/었', '-(스)ㅂ니까']},
            {term: '아릅답다', source: '아름다웠을까',    rule: 'adj', reasons: []},
            {term: '아릅답다', source: '아름다웠냐',      rule: 'adj', reasons: ['-았/었', '-(으)냐']},
            {term: '아릅답다', source: '아름답겠습니까',  rule: 'adj', reasons: ['-겠', '-(스)ㅂ니까']},
            {term: '아릅답다', source: '아름답겠냐',      rule: 'adj', reasons: ['-겠', '-(으)냐']},
            {term: '아릅답다', source: '아름답네',        rule: 'adj', reasons: ['-네']},
            {term: '아릅답다', source: '아름답구나',      rule: 'adj', reasons: ['-구나']},
            {term: '아릅답다', source: '아름다움',       rule: 'adj', reasons: ['-(으)ㅁ']},
            {term: '아릅답다', source: '아름다운',       rule: 'adj', reasons: ['-(으)ㄴ']},
            {term: '아릅답다', source: '아름답게',       rule: 'adj', reasons: ['-게']},
            {term: '아릅답다', source: '아름답고',       rule: 'adj', reasons: ['-고']},
            {term: '아릅답다', source: '아름다우면',     rule: 'adj', reasons: ['-(으)면']},
            {term: '아릅답다', source: '아름다우니',     rule: 'adj', reasons: ['-(으)니']},
