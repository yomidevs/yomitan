...
const tests = [
    {
        ...
        tests: [
            ...
            {term: '愛しい', source: '愛しくありません',      rule: 'adj-i', reasons: ['-masu', '-nai']},
            {term: '愛しい', source: '愛しくありませんでした', rule: 'adj-i', reasons: ['-masu', '-nai', '-ta']},
    ...
    },
    {
        ...
        tests: [
            ...
            {term: '食べる', source: '食べられる',       rule: 'v1', reasons: ['potential or passive form']},
            {term: '食べる', source: '食べられる',       rule: 'v1', reasons: ['potential or passive form']},
            {term: '食べる', source: '食べさせる',       rule: 'v1', reasons: ['causative form']},
            {term: '食べる', source: '食べさせられる',   rule: 'v1', reasons: ['causative form', 'potential or passive form']},
            {term: '食べる', source: '食べろ',           rule: 'v1', reasons: ['imperative form']},
            {term: '食べる', source: '食べない',         rule: 'v1', reasons: ['-nai']},
            {term: '食べる', source: '食べません',       rule: 'v1', reasons: ['-masu', '-nai']},
            {term: '食べる', source: '食べなかった',     rule: 'v1', reasons: ['-nai', '-ta']},
            {term: '食べる', source: '食べませんでした', rule: 'v1', reasons: ['-masu', '-nai', '-ta']},
            {term: '食べる', source: '食べなくて',       rule: 'v1', reasons: ['-nai', '-te']},
            ...
            {term: '食べる', source: '食べ',             rule: 'v1d', reasons: ['continuative form']},
            {term: '食べる', source: '食べましょう',     rule: 'v1', reasons: ['-masu', '-you']},
            {term: '食べる', source: '食べよう',         rule: 'v1', reasons: ['-you']},
    ...
    },
    {
        ...
        tests: [
            ...
            {term: '買う', source: '買える',           rule: 'v5', reasons: ['potential form']},
            {term: '買う', source: '買われる',         rule: 'v5', reasons: ['passive form']},
            {term: '買う', source: '買わせる',         rule: 'v5', reasons: ['causative form']},
            {term: '買う', source: '買わせられる',     rule: 'v5', reasons: ['causative form', 'potential or passive form']},
            {term: '買う', source: '買え',             rule: 'v5', reasons: ['imperative form']},
            {term: '買う', source: '買わない',         rule: 'v5', reasons: ['-nai']},
            {term: '買う', source: '買いません',       rule: 'v5', reasons: ['-masu', '-nai']},
            {term: '買う', source: '買わなかった',     rule: 'v5', reasons: ['-nai', '-ta']},
            {term: '買う', source: '買いませんでした', rule: 'v5', reasons: ['-masu', '-nai', '-ta']},
            {term: '買う', source: '買わなくて',       rule: 'v5', reasons: ['-nai', '-te']},
            {term: '買う', source: '買えない',         rule: 'v5', reasons: ['potential form', '-nai']},
            ...
            {term: '買う', source: '買い',             rule: 'v5', reasons: ['continuative form']},
            {term: '買う', source: '買いましょう',     rule: 'v5', reasons: ['-masu', '-you']},
            {term: '買う', source: '買おう',           rule: 'v5', reasons: ['-you']},
            {term: '買う', source: '買わされる',       rule: 'v5', reasons: ['causative-passive form']},
    ...
    },
    {
        ...
        tests: [
            ...
            {term: '行く', source: '行ける',           rule: 'v5', reasons: ['potential form']},
            {term: '行く', source: '行かれる',         rule: 'v5', reasons: ['passive form']},
            {term: '行く', source: '行かせる',         rule: 'v5', reasons: ['causative form']},
            {term: '行く', source: '行かせられる',     rule: 'v5', reasons: ['causative form', 'potential or passive form']},
            {term: '行く', source: '行け',             rule: 'v5', reasons: ['imperative form']},
            {term: '行く', source: '行かない',         rule: 'v5', reasons: ['-nai']},
            {term: '行く', source: '行きません',       rule: 'v5', reasons: ['-masu', '-nai']},
            {term: '行く', source: '行かなかった',     rule: 'v5', reasons: ['-nai', '-ta']},
            {term: '行く', source: '行きませんでした', rule: 'v5', reasons: ['-masu', '-nai', '-ta']},
            {term: '行く', source: '行かなくて',       rule: 'v5', reasons: ['-nai', '-te']},
            {term: '行く', source: '行けない',         rule: 'v5', reasons: ['potential form', '-nai']},
            ...
            {term: '行く', source: '行き',             rule: 'v5', reasons: ['continuative form']},
            {term: '行く', source: '行きましょう',     rule: 'v5', reasons: ['-masu', '-you']},
            {term: '行く', source: '行こう',           rule: 'v5', reasons: ['-you']},
            {term: '行く', source: '行かされる',       rule: 'v5', reasons: ['causative-passive form']},
    ...
    },
    {
        ...
        tests: [
            ...
            {term: '泳ぐ', source: '泳げる',           rule: 'v5', reasons: ['potential form']},
            {term: '泳ぐ', source: '泳がれる',         rule: 'v5', reasons: ['passive form']},
            {term: '泳ぐ', source: '泳がせる',         rule: 'v5', reasons: ['causative form']},
            {term: '泳ぐ', source: '泳がせられる',     rule: 'v5', reasons: ['causative form', 'potential or passive form']},
            {term: '泳ぐ', source: '泳げ',             rule: 'v5', reasons: ['imperative form']},
            {term: '泳ぐ', source: '泳がない',         rule: 'v5', reasons: ['-nai']},
            {term: '泳ぐ', source: '泳ぎません',       rule: 'v5', reasons: ['-masu', '-nai']},
            {term: '泳ぐ', source: '泳がなかった',     rule: 'v5', reasons: ['-nai', '-ta']},
            {term: '泳ぐ', source: '泳ぎませんでした', rule: 'v5', reasons: ['-masu', '-nai', '-ta']},
            {term: '泳ぐ', source: '泳がなくて',       rule: 'v5', reasons: ['-nai', '-te']},
            {term: '泳ぐ', source: '泳げない',         rule: 'v5', reasons: ['potential form', '-nai']},
            ...
            {term: '泳ぐ', source: '泳ぎ',             rule: 'v5', reasons: ['continuative form']},
            {term: '泳ぐ', source: '泳ぎましょう',     rule: 'v5', reasons: ['-masu', '-you']},
            {term: '泳ぐ', source: '泳ごう',           rule: 'v5', reasons: ['-you']},
            {term: '泳ぐ', source: '泳がされる',       rule: 'v5', reasons: ['causative-passive form']},
    ...
    },
    {
        ...
        tests: [
            ...
            {term: '話す', source: '話せる',           rule: 'v5', reasons: ['potential form']},
            {term: '話す', source: '話される',         rule: 'v5', reasons: ['passive form']},
            {term: '話す', source: '話させる',         rule: 'v5', reasons: ['causative form']},
            {term: '話す', source: '話させられる',     rule: 'v5', reasons: ['causative form', 'potential or passive form']},
            {term: '話す', source: '話せ',             rule: 'v5', reasons: ['imperative form']},
            {term: '話す', source: '話さない',         rule: 'v5', reasons: ['-nai']},
            {term: '話す', source: '話しません',       rule: 'v5', reasons: ['-masu', '-nai']},
            {term: '話す', source: '話さなかった',     rule: 'v5', reasons: ['-nai', '-ta']},
            {term: '話す', source: '話しませんでした', rule: 'v5', reasons: ['-masu', '-nai', '-ta']},
            {term: '話す', source: '話さなくて',       rule: 'v5', reasons: ['-nai', '-te']},
            {term: '話す', source: '話せない',         rule: 'v5', reasons: ['potential form', '-nai']},
            ...
            {term: '話す', source: '話し',             rule: 'v5', reasons: ['continuative form']},
            {term: '話す', source: '話しましょう',     rule: 'v5', reasons: ['-masu', '-you']},
            {term: '話す', source: '話そう',           rule: 'v5', reasons: ['-you']},
            // ['causative-passive form']
            ...
            {term: '増す', source: '増せん',             rule: 'v5', reasons: ['potential form', '-n']},
        ],
    },
    {
        category: '-tsu verbs',
        ...
        tests: [
            ...
            {term: '待つ', source: '待てる',           rule: 'v5', reasons: ['potential form']},
            {term: '待つ', source: '待たれる',         rule: 'v5', reasons: ['passive form']},
            {term: '待つ', source: '待たせる',         rule: 'v5', reasons: ['causative form']},
            {term: '待つ', source: '待たせられる',     rule: 'v5', reasons: ['causative form', 'potential or passive form']},
            {term: '待つ', source: '待て',             rule: 'v5', reasons: ['imperative form']},
            {term: '待つ', source: '待たない',         rule: 'v5', reasons: ['-nai']},
            {term: '待つ', source: '待ちません',       rule: 'v5', reasons: ['-masu', '-nai']},
            {term: '待つ', source: '待たなかった',     rule: 'v5', reasons: ['-nai', '-ta']},
            {term: '待つ', source: '待ちませんでした', rule: 'v5', reasons: ['-masu', '-nai', '-ta']},
            {term: '待つ', source: '待たなくて',       rule: 'v5', reasons: ['-nai', '-te']},
            {term: '待つ', source: '待てない',         rule: 'v5', reasons: ['potential form', '-nai']},
            ...
            {term: '待つ', source: '待ち',             rule: 'v5', reasons: ['continuative form']},
            {term: '待つ', source: '待ちましょう',     rule: 'v5', reasons: ['-masu', '-you']},
            {term: '待つ', source: '待とう',           rule: 'v5', reasons: ['-you']},
            {term: '待つ', source: '待たされる',       rule: 'v5', reasons: ['causative-passive form']},
    ...
    },
    {
        ...
        tests: [
            ...
            {term: '死ぬ', source: '死ねる',           rule: 'v5', reasons: ['potential form']},
            {term: '死ぬ', source: '死なれる',         rule: 'v5', reasons: ['passive form']},
            {term: '死ぬ', source: '死なせる',         rule: 'v5', reasons: ['causative form']},
            {term: '死ぬ', source: '死なせられる',     rule: 'v5', reasons: ['causative form', 'potential or passive form']},
            {term: '死ぬ', source: '死ね',             rule: 'v5', reasons: ['imperative form']},
            {term: '死ぬ', source: '死なない',         rule: 'v5', reasons: ['-nai']},
            {term: '死ぬ', source: '死にません',       rule: 'v5', reasons: ['-masu', '-nai']},
            {term: '死ぬ', source: '死ななかった',     rule: 'v5', reasons: ['-nai', '-ta']},
            {term: '死ぬ', source: '死にませんでした', rule: 'v5', reasons: ['-masu', '-nai', '-ta']},
            {term: '死ぬ', source: '死ななくて',       rule: 'v5', reasons: ['-nai', '-te']},
            {term: '死ぬ', source: '死ねない',         rule: 'v5', reasons: ['potential form', '-nai']},
            ...
            {term: '死ぬ', source: '死に',             rule: 'v5', reasons: ['continuative form']},
            {term: '死ぬ', source: '死にましょう',     rule: 'v5', reasons: ['-masu', '-you']},
            {term: '死ぬ', source: '死のう',           rule: 'v5', reasons: ['-you']},
            {term: '死ぬ', source: '死なされる',       rule: 'v5', reasons: ['causative-passive form']},
    ...
    },
    {
        ...
        tests: [
            ...
            {term: '遊ぶ', source: '遊べる',           rule: 'v5', reasons: ['potential form']},
            {term: '遊ぶ', source: '遊ばれる',         rule: 'v5', reasons: ['passive form']},
            {term: '遊ぶ', source: '遊ばせる',         rule: 'v5', reasons: ['causative form']},
            {term: '遊ぶ', source: '遊ばせられる',     rule: 'v5', reasons: ['causative form', 'potential or passive form']},
            {term: '遊ぶ', source: '遊べ',             rule: 'v5', reasons: ['imperative form']},
            {term: '遊ぶ', source: '遊ばない',         rule: 'v5', reasons: ['-nai']},
            {term: '遊ぶ', source: '遊びません',       rule: 'v5', reasons: ['-masu', '-nai']},
            {term: '遊ぶ', source: '遊ばなかった',     rule: 'v5', reasons: ['-nai', '-ta']},
            {term: '遊ぶ', source: '遊びませんでした', rule: 'v5', reasons: ['-masu', '-nai', '-ta']},
            {term: '遊ぶ', source: '遊ばなくて',       rule: 'v5', reasons: ['-nai', '-te']},
            {term: '遊ぶ', source: '遊べない',         rule: 'v5', reasons: ['potential form', '-nai']},
            ...
            {term: '遊ぶ', source: '遊び',             rule: 'v5', reasons: ['continuative form']},
            {term: '遊ぶ', source: '遊びましょう',     rule: 'v5', reasons: ['-masu', '-you']},
            {term: '遊ぶ', source: '遊ぼう',           rule: 'v5', reasons: ['-you']},
            {term: '遊ぶ', source: '遊ばされる',       rule: 'v5', reasons: ['causative-passive form']},
    ...
    },
    {
        ...
        tests: [
            ...
            {term: '飲む', source: '飲める',           rule: 'v5', reasons: ['potential form']},
            {term: '飲む', source: '飲まれる',         rule: 'v5', reasons: ['passive form']},
            {term: '飲む', source: '飲ませる',         rule: 'v5', reasons: ['causative form']},
            {term: '飲む', source: '飲ませられる',     rule: 'v5', reasons: ['causative form', 'potential or passive form']},
            {term: '飲む', source: '飲め',             rule: 'v5', reasons: ['imperative form']},
            {term: '飲む', source: '飲まない',         rule: 'v5', reasons: ['-nai']},
            {term: '飲む', source: '飲みません',       rule: 'v5', reasons: ['-masu', '-nai']},
            {term: '飲む', source: '飲まなかった',     rule: 'v5', reasons: ['-nai', '-ta']},
            {term: '飲む', source: '飲みませんでした', rule: 'v5', reasons: ['-masu', '-nai', '-ta']},
            {term: '飲む', source: '飲まなくて',       rule: 'v5', reasons: ['-nai', '-te']},
            {term: '飲む', source: '飲めない',         rule: 'v5', reasons: ['potential form', '-nai']},
            ...
            {term: '飲む', source: '飲み',             rule: 'v5', reasons: ['continuative form']},
            {term: '飲む', source: '飲みましょう',     rule: 'v5', reasons: ['-masu', '-you']},
            {term: '飲む', source: '飲もう',           rule: 'v5', reasons: ['-you']},
            {term: '飲む', source: '飲まされる',       rule: 'v5', reasons: ['causative-passive form']},
    ...
    },
    {
        ...
        tests: [
            ...
            {term: '作る', source: '作れる',           rule: 'v5', reasons: ['potential form']},
            {term: '作る', source: '作られる',         rule: 'v5', reasons: ['passive form']},
            {term: '作る', source: '作らせる',         rule: 'v5', reasons: ['causative form']},
            {term: '作る', source: '作らせられる',     rule: 'v5', reasons: ['causative form', 'potential or passive form']},
            {term: '作る', source: '作れ',             rule: 'v5', reasons: ['imperative form']},
            {term: '作る', source: '作らない',         rule: 'v5', reasons: ['-nai']},
            {term: '作る', source: '作りません',       rule: 'v5', reasons: ['-masu', '-nai']},
            {term: '作る', source: '作らなかった',     rule: 'v5', reasons: ['-nai', '-ta']},
            {term: '作る', source: '作りませんでした', rule: 'v5', reasons: ['-masu', '-nai', '-ta']},
            {term: '作る', source: '作らなくて',       rule: 'v5', reasons: ['-nai', '-te']},
            {term: '作る', source: '作れない',         rule: 'v5', reasons: ['potential form', '-nai']},
            ...
            {term: '作る', source: '作り',             rule: 'v5', reasons: ['continuative form']},
            {term: '作る', source: '作りましょう',     rule: 'v5', reasons: ['-masu', '-you']},
            {term: '作る', source: '作ろう',           rule: 'v5', reasons: ['-you']},
            {term: '作る', source: '作らされる',       rule: 'v5', reasons: ['causative-passive form']},
    ...
    },
    {
        ...
        tests: [
            ...
            {term: '為る', source: '為られる',       rule: 'vs', reasons: ['potential or passive form']},
            {term: '為る', source: '為れる',         rule: 'vs', reasons: ['passive form']},
            {term: '為る', source: '為せる',         rule: 'vs', reasons: ['causative form']},
            {term: '為る', source: '為させる',       rule: 'vs', reasons: ['causative form']},
            {term: '為る', source: '為せられる',     rule: 'vs', reasons: ['causative form', 'potential or passive form']},
            {term: '為る', source: '為させられる',   rule: 'vs', reasons: ['causative form', 'potential or passive form']},
            {term: '為る', source: '為ろ',           rule: 'vs', reasons: ['imperative form']},
            {term: '為る', source: '為ない',         rule: 'vs', reasons: ['-nai']},
            {term: '為る', source: '為ません',       rule: 'vs', reasons: ['-masu', '-nai']},
            {term: '為る', source: '為なかった',     rule: 'vs', reasons: ['-nai', '-ta']},
            {term: '為る', source: '為ませんでした', rule: 'vs', reasons: ['-masu', '-nai', '-ta']},
            {term: '為る', source: '為なくて',       rule: 'vs', reasons: ['-nai', '-te']},
            {term: '為る', source: '為られない',     rule: 'vs', reasons: ['potential or passive form', '-nai']},
            {term: '為る', source: '為れない',       rule: 'vs', reasons: ['passive form', '-nai']},
            {term: '為る', source: '為せない',       rule: 'vs', reasons: ['causative form', '-nai']},
            ...
            // ['continuative form']
            {term: '為る', source: '為ましょう',     rule: 'vs', reasons: ['-masu', '-you']},
            {term: '為る', source: '為よう',         rule: 'vs', reasons: ['-you']},
            // ['causative-passive form']
            ...
            {term: 'する', source: 'できる',         rule: 'vs', reasons: ['potential form']},
            {term: 'する', source: '出来る',         rule: 'vs', reasons: ['potential form']},
            {term: 'する', source: 'せられる',       rule: 'vs', reasons: ['potential or passive form']},
            {term: 'する', source: 'される',         rule: 'vs', reasons: ['passive form']},
            {term: 'する', source: 'させる',         rule: 'vs', reasons: ['causative form']},
            {term: 'する', source: 'せさせる',       rule: 'vs', reasons: ['causative form']},
            {term: 'する', source: 'させられる',     rule: 'vs', reasons: ['causative form', 'potential or passive form']},
            {term: 'する', source: 'せさせられる',   rule: 'vs', reasons: ['causative form', 'potential or passive form']},
            {term: 'する', source: 'しろ',           rule: 'vs', reasons: ['imperative form']},
            {term: 'する', source: 'しない',         rule: 'vs', reasons: ['-nai']},
            {term: 'する', source: 'しません',       rule: 'vs', reasons: ['-masu', '-nai']},
            {term: 'する', source: 'しなかった',     rule: 'vs', reasons: ['-nai', '-ta']},
            {term: 'する', source: 'しませんでした', rule: 'vs', reasons: ['-masu', '-nai', '-ta']},
            {term: 'する', source: 'しなくて',       rule: 'vs', reasons: ['-nai', '-te']},
            {term: 'する', source: 'せられない',     rule: 'vs', reasons: ['potential or passive form', '-nai']},
            {term: 'する', source: 'されない',       rule: 'vs', reasons: ['passive form', '-nai']},
            {term: 'する', source: 'させない',       rule: 'vs', reasons: ['causative form', '-nai']},
            ...
            {term: 'する', source: 'し',             rule: 'vs', reasons: ['continuative form']},
            {term: 'する', source: 'しましょう',     rule: 'vs', reasons: ['-masu', '-you']},
            {term: 'する', source: 'しよう',         rule: 'vs', reasons: ['-you']},
            {term: 'する', source: 'しなきゃ',        rule: 'vs', reasons: ['-nai', '-ba', '-ya']},
            // ['causative-passive form']
            ...
            {term: '来る', source: '来られる',       rule: 'vk', reasons: ['potential or passive form']},
            {term: '来る', source: '来られる',       rule: 'vk', reasons: ['potential or passive form']},
            {term: '来る', source: '来させる',       rule: 'vk', reasons: ['causative form']},
            {term: '来る', source: '来させられる',   rule: 'vk', reasons: ['causative form', 'potential or passive form']},
            {term: '来る', source: '来い',           rule: 'vk', reasons: ['imperative form']},
            {term: '来る', source: '来ない',         rule: 'vk', reasons: ['-nai']},
            {term: '来る', source: '来ません',       rule: 'vk', reasons: ['-masu', '-nai']},
            {term: '来る', source: '来なかった',     rule: 'vk', reasons: ['-nai', '-ta']},
            {term: '来る', source: '来ませんでした', rule: 'vk', reasons: ['-masu', '-nai', '-ta']},
            {term: '来る', source: '来なくて',       rule: 'vk', reasons: ['-nai', '-te']},
            ...
            {term: '来る', source: '来',             rule: 'vk', reasons: ['continuative form']},
            {term: '来る', source: '来ましょう',     rule: 'vk', reasons: ['-masu', '-you']},
            {term: '来る', source: '来よう',         rule: 'vk', reasons: ['-you']},
            // ['causative-passive form']
            ...
            {term: '來る', source: '來られる',       rule: 'vk', reasons: ['potential or passive form']},
            {term: '來る', source: '來られる',       rule: 'vk', reasons: ['potential or passive form']},
            {term: '來る', source: '來させる',       rule: 'vk', reasons: ['causative form']},
            {term: '來る', source: '來させられる',   rule: 'vk', reasons: ['causative form', 'potential or passive form']},
            {term: '來る', source: '來い',           rule: 'vk', reasons: ['imperative form']},
            {term: '來る', source: '來ない',         rule: 'vk', reasons: ['-nai']},
            {term: '來る', source: '來ません',       rule: 'vk', reasons: ['-masu', '-nai']},
            {term: '來る', source: '來なかった',     rule: 'vk', reasons: ['-nai', '-ta']},
            {term: '來る', source: '來ませんでした', rule: 'vk', reasons: ['-masu', '-nai', '-ta']},
            {term: '來る', source: '來なくて',       rule: 'vk', reasons: ['-nai', '-te']},
            ...
            {term: '來る', source: '來',             rule: 'vk', reasons: ['continuative form']},
            {term: '來る', source: '來ましょう',     rule: 'vk', reasons: ['-masu', '-you']},
            {term: '來る', source: '來よう',         rule: 'vk', reasons: ['-you']},
            // ['causative-passive form']
            ...
            {term: 'くる', source: 'こられる',       rule: 'vk', reasons: ['potential or passive form']},
            {term: 'くる', source: 'こられる',       rule: 'vk', reasons: ['potential or passive form']},
            {term: 'くる', source: 'こさせる',       rule: 'vk', reasons: ['causative form']},
            {term: 'くる', source: 'こさせられる',   rule: 'vk', reasons: ['causative form', 'potential or passive form']},
            {term: 'くる', source: 'こい',           rule: 'vk', reasons: ['imperative form']},
            {term: 'くる', source: 'こない',         rule: 'vk', reasons: ['-nai']},
            {term: 'くる', source: 'きません',       rule: 'vk', reasons: ['-masu', '-nai']},
            {term: 'くる', source: 'こなかった',     rule: 'vk', reasons: ['-nai', '-ta']},
            {term: 'くる', source: 'きませんでした', rule: 'vk', reasons: ['-masu', '-nai', '-ta']},
            {term: 'くる', source: 'こなくて',       rule: 'vk', reasons: ['-nai', '-te']},
            ...
            {term: 'くる', source: 'き',             rule: 'vk', reasons: ['continuative form']},
            {term: 'くる', source: 'きましょう',     rule: 'vk', reasons: ['-masu', '-you']},
            {term: 'くる', source: 'こよう',         rule: 'vk', reasons: ['-you']},
            // ['causative-passive form']
    ...
    },
    {
        ...
        tests: [
            ...
            {term: '論ずる', source: '論ぜられる',       rule: 'vz', reasons: ['potential or passive form']},
            {term: '論ずる', source: '論ざれる',         rule: 'vz', reasons: ['potential or passive form']},
            {term: '論ずる', source: '論じされる',       rule: 'vz', reasons: ['passive form']},
            {term: '論ずる', source: '論ぜされる',       rule: 'vz', reasons: ['passive form']},
            {term: '論ずる', source: '論じさせる',       rule: 'vz', reasons: ['causative form']},
            {term: '論ずる', source: '論ぜさせる',       rule: 'vz', reasons: ['causative form']},
            {term: '論ずる', source: '論じさせられる',   rule: 'vz', reasons: ['causative form', 'potential or passive form']},
            {term: '論ずる', source: '論ぜさせられる',   rule: 'vz', reasons: ['causative form', 'potential or passive form']},
            {term: '論ずる', source: '論じろ',           rule: 'vz', reasons: ['imperative form']},
            {term: '論ずる', source: '論じない',         rule: 'vz', reasons: ['-nai']},
            {term: '論ずる', source: '論じません',       rule: 'vz', reasons: ['-masu', '-nai']},
            {term: '論ずる', source: '論じなかった',     rule: 'vz', reasons: ['-nai', '-ta']},
            {term: '論ずる', source: '論じませんでした', rule: 'vz', reasons: ['-masu', '-nai', '-ta']},
            {term: '論ずる', source: '論じなくて',       rule: 'vz', reasons: ['-nai', '-te']},
            {term: '論ずる', source: '論ぜられない',     rule: 'vz', reasons: ['potential or passive form', '-nai']},
            {term: '論ずる', source: '論じされない',     rule: 'vz', reasons: ['passive form', '-nai']},
            {term: '論ずる', source: '論ぜされない',     rule: 'vz', reasons: ['passive form', '-nai']},
            {term: '論ずる', source: '論じさせない',     rule: 'vz', reasons: ['causative form', '-nai']},
            ...
            // ['continuative form']
            {term: '論ずる', source: '論じましょう',     rule: 'vz', reasons: ['-masu', '-you']},
            {term: '論ずる', source: '論じよう',         rule: 'vz', reasons: ['-you']},
            // ['causative-passive form']
    ...
    },
    {
        ...
        tests: [
            ...
            {term: 'できる',     source: 'できねえ',   rule: 'v1',    reasons: ['-nai', '-e']},
            {term: 'しんじる',   source: 'しんじねえ', rule: 'v1',    reasons: ['-nai', '-e']},
            ...
            {term: 'できる',     source: 'できねぇ',   rule: 'v1',    reasons: ['-nai', '-e']},
            {term: 'しんじる',   source: 'しんじねぇ', rule: 'v1',    reasons: ['-nai', '-e']},
    ...
    },
    {
        ...
        valid: true,
        tests: [
            {term: '抱き抱える', source: '抱き抱えていなければ', rule: 'v1', reasons: ['-te', '-teiru', '-nai', '-ba']},
            {term: '抱きかかえる', source: '抱きかかえていなければ', rule: 'v1', reasons: ['-te', '-teiru', '-nai', '-ba']},
            {term: '打ち込む', source: '打ち込んでいませんでした', rule: 'v5', reasons: ['-te', '-teiru', '-masu', '-nai', '-ta']},
            {term: '食べる', source: '食べさせられたくなかった', rule: 'v1', reasons: ['causative form', 'potential or passive form', '-tai', '-nai', '-ta']},
        ],
    },
    {
        category: 'kawaii',
    ...
    },
    {
        ...
        valid: false,
        tests: [
            {term: '食べる', source: '食べて', rule: null, reasons: ['-te', '-teiru', 'continuative form']},

            {term: 'なる', source: 'なりません', rule: null, reasons: ['-masu', 'potential form', '-n']},
        ],
    },
    // Kansai-ben
    {
    ...
    },
    {
        ...
        valid: true,
        tests: [
            {term: 'よろしい', source: 'よろしゅうない', rule: null, reasons: ['-nai', 'kansai-ben adjective negative']},
            {term: '宜しい', source: '宜しゅうない', rule: null, reasons: ['-nai', 'kansai-ben adjective negative']},
            {term: 'よい', source: 'ようない', rule: null, reasons: ['-nai', 'kansai-ben adjective negative']},
            {term: '良い', source: '良うない', rule: null, reasons: ['-nai', 'kansai-ben adjective negative']},
        ],
    },
    {
        ...
        valid: true,
        tests: [
            {term: '食べる', source: '食べへん', rule: null, reasons: ['-nai', 'kansai-ben negative']},
            {term: '食べる', source: '食べへんかった', rule: null, reasons: ['-nai', '-ta', 'kansai-ben negative']},
        ],
    },
    {
