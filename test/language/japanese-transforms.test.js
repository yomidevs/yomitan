...
const tests = [
    ...
    },
    {
        ...
        tests: [
            ...
            {term: '食べる', source: '食べられない',     rule: 'v1', reasons: ['potential or passive', '-nai']},
            {term: '食べる', source: '食べられない',     rule: 'v1', reasons: ['potential or passive', '-nai']},
            {term: '食べる', source: '食べさせない',     rule: 'v1', reasons: ['causative', '-nai']},
            {term: '食べる', source: '食べさせられない', rule: 'v1', reasons: ['causative', 'potential or passive', '-nai']},
    ...
    },
    {
        ...
        tests: [
            ...
            {term: '買う', source: '買えない',         rule: 'v5', reasons: ['potential', '-nai']},
            {term: '買う', source: '買われない',       rule: 'v5', reasons: ['passive', '-nai']},
            {term: '買う', source: '買わせない',       rule: 'v5', reasons: ['causative', '-nai']},
            {term: '買う', source: '買わせられない',   rule: 'v5', reasons: ['causative', 'potential or passive', '-nai']},
    ...
    },
    {
        ...
        tests: [
            ...
            {term: '行く', source: '行けない',         rule: 'v5', reasons: ['potential', '-nai']},
            {term: '行く', source: '行かれない',       rule: 'v5', reasons: ['passive', '-nai']},
            {term: '行く', source: '行かせない',       rule: 'v5', reasons: ['causative', '-nai']},
            {term: '行く', source: '行かせられない',   rule: 'v5', reasons: ['causative', 'potential or passive', '-nai']},
    ...
    },
    {
        ...
        tests: [
            ...
            {term: '泳ぐ', source: '泳げない',         rule: 'v5', reasons: ['potential', '-nai']},
            {term: '泳ぐ', source: '泳がれない',       rule: 'v5', reasons: ['passive', '-nai']},
            {term: '泳ぐ', source: '泳がせない',       rule: 'v5', reasons: ['causative', '-nai']},
            {term: '泳ぐ', source: '泳がせられない',   rule: 'v5', reasons: ['causative', 'potential or passive', '-nai']},
    ...
    },
    {
        ...
        tests: [
            ...
            {term: '話す', source: '話せない',         rule: 'v5', reasons: ['potential', '-nai']},
            {term: '話す', source: '話されない',       rule: 'v5', reasons: ['passive', '-nai']},
            {term: '話す', source: '話させない',       rule: 'v5', reasons: ['causative', '-nai']},
            {term: '話す', source: '話させられない',   rule: 'v5', reasons: ['causative', 'potential or passive', '-nai']},
    ...
    },
    {
        ...
        tests: [
            ...
            {term: '待つ', source: '待てない',         rule: 'v5', reasons: ['potential', '-nai']},
            {term: '待つ', source: '待たれない',       rule: 'v5', reasons: ['passive', '-nai']},
            {term: '待つ', source: '待たせない',       rule: 'v5', reasons: ['causative', '-nai']},
            {term: '待つ', source: '待たせられない',   rule: 'v5', reasons: ['causative', 'potential or passive', '-nai']},
    ...
    },
    {
        ...
        tests: [
            ...
            {term: '死ぬ', source: '死ねない',         rule: 'v5', reasons: ['potential', '-nai']},
            {term: '死ぬ', source: '死なれない',       rule: 'v5', reasons: ['passive', '-nai']},
            {term: '死ぬ', source: '死なせない',       rule: 'v5', reasons: ['causative', '-nai']},
            {term: '死ぬ', source: '死なせられない',   rule: 'v5', reasons: ['causative', 'potential or passive', '-nai']},
    ...
    },
    {
        ...
        tests: [
            ...
            {term: '遊ぶ', source: '遊べない',         rule: 'v5', reasons: ['potential', '-nai']},
            {term: '遊ぶ', source: '遊ばれない',       rule: 'v5', reasons: ['passive', '-nai']},
            {term: '遊ぶ', source: '遊ばせない',       rule: 'v5', reasons: ['causative', '-nai']},
            {term: '遊ぶ', source: '遊ばせられない',   rule: 'v5', reasons: ['causative', 'potential or passive', '-nai']},
    ...
    },
    {
        ...
        tests: [
            ...
            {term: '飲む', source: '飲めない',         rule: 'v5', reasons: ['potential', '-nai']},
            {term: '飲む', source: '飲まれない',       rule: 'v5', reasons: ['passive', '-nai']},
            {term: '飲む', source: '飲ませない',       rule: 'v5', reasons: ['causative', '-nai']},
            {term: '飲む', source: '飲ませられない',   rule: 'v5', reasons: ['causative', 'potential or passive', '-nai']},
    ...
    },
    {
        ...
        tests: [
            ...
            {term: '作る', source: '作れない',         rule: 'v5', reasons: ['potential', '-nai']},
            {term: '作る', source: '作られない',       rule: 'v5', reasons: ['passive', '-nai']},
            {term: '作る', source: '作らせない',       rule: 'v5', reasons: ['causative', '-nai']},
            {term: '作る', source: '作らせられない',   rule: 'v5', reasons: ['causative', 'potential or passive', '-nai']},
    ...
    },
    {
        ...
        tests: [
            ...
            {term: '為る', source: '為られない',     rule: 'vs', reasons: ['potential or passive', '-nai']},
            {term: '為る', source: '為れない',       rule: 'vs', reasons: ['passive', '-nai']},
            {term: '為る', source: '為せない',       rule: 'vs', reasons: ['causative', '-nai']},
            {term: '為る', source: '為させない',     rule: 'vs', reasons: ['causative', '-nai']},
            {term: '為る', source: '為せられない',   rule: 'vs', reasons: ['causative', 'potential or passive', '-nai']},
            {term: '為る', source: '為させられない', rule: 'vs', reasons: ['causative', 'potential or passive', '-nai']},
            ...
            {term: 'する', source: 'せられない',     rule: 'vs', reasons: ['potential or passive', '-nai']},
            {term: 'する', source: 'されない',       rule: 'vs', reasons: ['passive', '-nai']},
            {term: 'する', source: 'させない',       rule: 'vs', reasons: ['causative', '-nai']},
            {term: 'する', source: 'せさせない',     rule: 'vs', reasons: ['causative', '-nai']},
            {term: 'する', source: 'させられない',   rule: 'vs', reasons: ['causative', 'potential or passive', '-nai']},
            {term: 'する', source: 'せさせられない', rule: 'vs', reasons: ['causative', 'potential or passive', '-nai']},
            ...
            {term: '来る', source: '来られない',     rule: 'vk', reasons: ['potential or passive', '-nai']},
            {term: '来る', source: '来られない',     rule: 'vk', reasons: ['potential or passive', '-nai']},
            {term: '来る', source: '来させない',     rule: 'vk', reasons: ['causative', '-nai']},
            {term: '来る', source: '来させられない', rule: 'vk', reasons: ['causative', 'potential or passive', '-nai']},
            ...
            {term: '來る', source: '來られない',     rule: 'vk', reasons: ['potential or passive', '-nai']},
            {term: '來る', source: '來られない',     rule: 'vk', reasons: ['potential or passive', '-nai']},
            {term: '來る', source: '來させない',     rule: 'vk', reasons: ['causative', '-nai']},
            {term: '來る', source: '來させられない', rule: 'vk', reasons: ['causative', 'potential or passive', '-nai']},
            ...
            {term: 'くる', source: 'こられない',     rule: 'vk', reasons: ['potential or passive', '-nai']},
            {term: 'くる', source: 'こられない',     rule: 'vk', reasons: ['potential or passive', '-nai']},
            {term: 'くる', source: 'こさせない',     rule: 'vk', reasons: ['causative', '-nai']},
            {term: 'くる', source: 'こさせられない', rule: 'vk', reasons: ['causative', 'potential or passive', '-nai']},
    ...
    },
    {
        ...
        tests: [
            ...
            {term: '論ずる', source: '論ぜられない',     rule: 'vz', reasons: ['potential or passive', '-nai']},
            {term: '論ずる', source: '論じされない',     rule: 'vz', reasons: ['passive', '-nai']},
            {term: '論ずる', source: '論ぜされない',     rule: 'vz', reasons: ['passive', '-nai']},
            {term: '論ずる', source: '論じさせない',     rule: 'vz', reasons: ['causative', '-nai']},
            {term: '論ずる', source: '論ぜさせない',     rule: 'vz', reasons: ['causative', '-nai']},
            {term: '論ずる', source: '論じさせられない', rule: 'vz', reasons: ['causative', 'potential or passive', '-nai']},
            {term: '論ずる', source: '論ぜさせられない', rule: 'vz', reasons: ['causative', 'potential or passive', '-nai']},
    ...
    },
    {
        ...
        tests: [
            ...
            {term: '食べる', source: '食べさせられたくなかった', rule: 'v1', reasons: ['causative', 'potential or passive', '-tai', '-nai', '-ta']},
        ],
    },
    {
        category: 'kawaii',
