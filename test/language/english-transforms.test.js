...
const tests = [
    ...
    },
    {
        ...
        tests: [
            ...
            {term: 'admire', source: 'admirably', rule: 'v', reasons: ['-able', 'adverb']},
        ],
    },
    {
...

    {
        ...
        valid: true,
        tests: [
            {term: 'forget', source: 'unforgettable', rule: 'v', reasons: ['un-', '-able']},
            {term: 'forget', source: 'forgettable', rule: 'v', reasons: ['-able']},
            {term: 'like', source: 'likeable', rule: 'v', reasons: ['-able']},
            {term: 'do', source: 'doable', rule: 'v', reasons: ['-able']},
            {term: 'desire', source: 'desirable', rule: 'v', reasons: ['-able']},
            {term: 'rely', source: 'reliable', rule: 'v', reasons: ['-able']},
            {term: 'move', source: 'movable', rule: 'v', reasons: ['-able']},
            {term: 'adore', source: 'adorable', rule: 'v', reasons: ['-able']},
            {term: 'carry', source: 'carriable', rule: 'v', reasons: ['-able']},
        ],
    },
];
