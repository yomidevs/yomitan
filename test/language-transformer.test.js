    ...
    const data = [
        {
            ...
            tests: [
                ...
                {term: '愛しい', source: '愛しけりゃ',              rule: 'adj-i', reasons: ['-rya']}
            ]
        },
        {
            ...
            tests: [
                ...
                {term: '食べる', source: '食べん',           rule: 'v1', reasons: ['-nu']},
        ...
        },
        {
            ...
            tests: [
                ...
                {term: '行く', source: '行かん',           rule: 'v5', reasons: ['-nu']},
        ...
        },
        {
            ...
            tests: [
                ...
                {term: '泳ぐ', source: '泳がん',           rule: 'v5', reasons: ['-nu']},
        ...
        },
        {
            ...
            tests: [
                ...
                {term: '話す', source: '話さん',           rule: 'v5', reasons: ['-nu']},
        ...
        },
        {
            ...
            tests: [
                ...
                {term: '待つ', source: '待たん',           rule: 'v5', reasons: ['-nu']},
        ...
        },
        {
            ...
            tests: [
                ...
                {term: '死ぬ', source: '死なん',           rule: 'v5', reasons: ['-nu']},
        ...
        },
        {
            ...
            tests: [
                ...
                {term: '遊ぶ', source: '遊ばん',           rule: 'v5', reasons: ['-nu']},
        ...
        },
        {
            ...
            tests: [
                ...
                {term: '飲む', source: '飲まん',           rule: 'v5', reasons: ['-nu']},
        ...
        },
        {
            ...
            tests: [
                ...
                {term: '作る', source: '作りゃ',           rule: 'v5', reasons: ['-ba']},
                ...
                {term: '作る', source: '作らん',           rule: 'v5', reasons: ['-nu']},
        ...
        },
        {
            ...
            tests: [
                ...
                {term: '為る', source: '為ん',           rule: 'vs', reasons: ['-nu']},
                ...
                {term: 'する', source: 'せん',           rule: 'vs', reasons: ['-nu']},
                ...
                {term: '来る', source: '来ん',           rule: 'vk', reasons: ['-nu']},
                ...
                {term: '來る', source: '來ん',           rule: 'vk', reasons: ['-nu']},
                ...
                {term: 'くる', source: 'こん',           rule: 'vk', reasons: ['-nu']},
        ...
        },
        {
            ...
            tests: [
                ...
                {term: '論ずる', source: '論ぜん',           rule: 'vz', reasons: ['-nu']},
